...
export class StatusPayment1726292211442 implements MigrationInterface {
    name = 'StatusPayment1726292211442'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`payment\` ADD \`status\` enum ('PENDING', 'SUCCESS', 'FAILED') NOT NULL DEFAULT 'PENDING'`);
